...
import com.hello_world_testingggg.api.client.HelloWorldTestinggggClientAsyncImpl
...
/**
 * A class that allows building an instance of [HelloWorldTestinggggClientAsync] with [OkHttpClient]
 * as the underlying [HttpClient].
 */
class HelloWorldTestinggggOkHttpClientAsync private constructor() {
    ...
    companion object {
         ...
         */
        fun fromEnv(): HelloWorldTestinggggClientAsync = builder().fromEnv().build()
    }

    /** A builder for [HelloWorldTestinggggOkHttpClientAsync]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [HelloWorldTestinggggClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): HelloWorldTestinggggClientAsync =
            HelloWorldTestinggggClientAsyncImpl(
                clientOptions
                    .httpClient(
