...
package com.hello_world_testingggg.api.client.okhttp

import com.fasterxml.jackson.databind.json.JsonMapper
import com.hello_world_testingggg.api.client.HelloWorldTestinggggClient
import com.hello_world_testingggg.api.client.HelloWorldTestinggggClientImpl
import com.hello_world_testingggg.api.core.ClientOptions
import com.hello_world_testingggg.api.core.LogLevel
import com.hello_world_testingggg.api.core.Sleeper
import com.hello_world_testingggg.api.core.Timeout
import com.hello_world_testingggg.api.core.http.Headers
import com.hello_world_testingggg.api.core.http.HttpClient
...
/**
 * A class that allows building an instance of [HelloWorldTestinggggClient] with [OkHttpClient] as
 * the underlying [HttpClient].
 */
class HelloWorldTestinggggOkHttpClient private constructor() {

    companion object {

        /**
         * Returns a mutable builder for constructing an instance of [HelloWorldTestinggggClient].
         */
        fun builder() = Builder()
         ...
         */
        fun fromEnv(): HelloWorldTestinggggClient = builder().fromEnv().build()
    }

    /** A builder for [HelloWorldTestinggggOkHttpClient]. */
    class Builder internal constructor() {
         ...
         *
         * Defaults to [com.hello_world_testingggg.api.core.jsonMapper]. The default is usually
        ...
        /**
         * Returns an immutable instance of [HelloWorldTestinggggClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): HelloWorldTestinggggClient =
            HelloWorldTestinggggClientImpl(
                clientOptions
                    .httpClient(
