...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class com.hello_world_testingggg.api.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class com.hello_world_testingggg.api.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class com.hello_world_testingggg.api.** {
    <init>(...);
