...
class MediaServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override suspend fun binaryAndJson(
    ...
    override suspend fun jsonAndXml(
    ...
    override suspend fun jsonFirst(
    ...
    override suspend fun schemaOnJson(
    ...
    override suspend fun schemaOnText(
    ...
    override suspend fun textFirst(
    ...
    override suspend fun vendorJson(
