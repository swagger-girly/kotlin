...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ParsedWebhookEvent].
         *
    ...
    /** A builder for [ParsedWebhookEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(parsedWebhookEvent: ParsedWebhookEvent) = apply {
            pet = parsedWebhookEvent.pet
            type = parsedWebhookEvent.type
            additionalProperties = parsedWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ParsedWebhookEvent].
         *
    ...
    override fun toString() =
        "ParsedWebhookEvent{pet=$pet, type=$type, additionalProperties=$additionalProperties}"
}
