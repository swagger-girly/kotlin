...
private constructor(
    ...
    private val latestRejection: JsonField<DecisionRejected>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        latestRejection: JsonField<DecisionRejected> = JsonMissing.of(),
     ...
     *   (e.g. if the server responded with an unexpected value).
     */
    fun latestRejection(): DecisionRejected? = latestRejection.getNullable("latestRejection")
    ...
    @JsonProperty("latestRejection")
    @ExcludeMissing
    fun _latestRejection(): JsonField<DecisionRejected> = latestRejection
    ...
    class Builder internal constructor() {
        ...
        private var latestRejection: JsonField<DecisionRejected> = JsonMissing.of()
        ...
        fun applicant(individual: Applicant.IndividualApplicant) =
            applicant(Applicant.ofIndividual(individual))

        /**
         * Alias for calling [applicant] with the following:
         * ```kotlin
         * Applicant.IndividualApplicant.builder()
         *     .applicantType(Application.Applicant.IndividualApplicant.ApplicantType.INDIVIDUAL)
         *     .name(name)
         *     .build()
         * ```
         */
        fun individualApplicant(name: String) =
            applicant(
                Applicant.IndividualApplicant.builder()
                    .applicantType(
                        Application.Applicant.IndividualApplicant.ApplicantType.INDIVIDUAL
                    )
                    .name(name)
                    .build()
            )
        ...
        fun applicant(organization: Applicant.OrganizationApplicant) =
            applicant(Applicant.ofOrganization(organization))

        /**
         * Alias for calling [applicant] with the following:
         * ```kotlin
         * Applicant.OrganizationApplicant.builder()
         *     .applicantType(Application.Applicant.OrganizationApplicant.ApplicantType.ORGANIZATION)
         *     .name(name)
         *     .build()
         * ```
         */
        fun organizationApplicant(name: String) =
            applicant(
                Applicant.OrganizationApplicant.builder()
                    .applicantType(
                        Application.Applicant.OrganizationApplicant.ApplicantType.ORGANIZATION
                    )
                    .name(name)
                    .build()
            )
        ...
        fun latestRejection(latestRejection: DecisionRejected) =
            latestRejection(JsonField.of(latestRejection))

        /**
         * Sets [Builder.latestRejection] to an arbitrary JSON value.
         *
         * You should usually call [Builder.latestRejection] with a well-typed [DecisionRejected]
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun latestRejection(latestRejection: JsonField<DecisionRejected>) = apply {
    ...
    private constructor(
        ...
        companion object {
            ...
            fun ofIndividual(individual: IndividualApplicant) = Applicant(individual = individual)
