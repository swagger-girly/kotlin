...
private constructor(
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             * Further updates to this [Builder] will not mutate the returned instance.
             */
            fun build(): Body = Body(file, metadata, url, additionalProperties.toMutableMap())
        }
        ...
        override fun toString() =
            "Body{file=$file, metadata=$metadata, url=$url, additionalProperties=$additionalProperties}"
    }
