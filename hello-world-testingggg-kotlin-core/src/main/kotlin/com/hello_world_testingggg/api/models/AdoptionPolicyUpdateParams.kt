...
class AdoptionPolicyUpdateParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AdoptionPolicyUpdateParams].
         *
    ...
    /** A builder for [AdoptionPolicyUpdateParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(adoptionPolicyUpdateParams: AdoptionPolicyUpdateParams) = apply {
            policyId = adoptionPolicyUpdateParams.policyId
            body = adoptionPolicyUpdateParams.body
            additionalHeaders = adoptionPolicyUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = adoptionPolicyUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [AdoptionPolicyUpdateParams].
         *
         ...
         */
        fun build(): AdoptionPolicyUpdateParams =
            AdoptionPolicyUpdateParams(
                policyId,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AdoptionPolicyUpdateParams &&
    ...
    override fun toString() =
        "AdoptionPolicyUpdateParams{policyId=$policyId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
