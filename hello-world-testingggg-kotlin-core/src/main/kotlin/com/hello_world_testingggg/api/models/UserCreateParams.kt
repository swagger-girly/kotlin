...
private constructor(
     ...
     * ```kotlin
     * val myObject: MyClass = userCreateParams.relatedCategory().convert(MyClass::class.java)
     * ```
     */
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```kotlin
     * val myObject: MyClass = userCreateParams.relatedCustomer().convert(MyClass::class.java)
     * ```
     */
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```kotlin
     * val myObject: MyClass = userCreateParams.relatedOrder().convert(MyClass::class.java)
     * ```
     */
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```kotlin
     * val myObject: MyClass = userCreateParams.relatedShelter().convert(MyClass::class.java)
     * ```
     */
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```kotlin
     * val myObject: MyClass = userCreateParams.relatedTag().convert(MyClass::class.java)
     * ```
     */
    ...
    class Builder internal constructor() {
        ...
        private var body: User.Builder = User.builder()
         ...
         * - etc.
         */
        fun body(body: User) = apply { this.body = body.toBuilder() }
