...
private constructor(
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            val ADOPTIONS_POLICY_CHANGED = of("adoptions.policy.changed")
        ...
        fun value(): Value =
            when (this) {
                ADOPTIONS_POLICY_CHANGED -> Value.ADOPTIONS_POLICY_CHANGED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                ADOPTIONS_POLICY_CHANGED -> Known.ADOPTIONS_POLICY_CHANGED
