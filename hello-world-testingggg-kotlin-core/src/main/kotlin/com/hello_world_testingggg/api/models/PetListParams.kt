...
class PetListParams
private constructor(
    private val createdAt: CreatedAtFilter?,
    ...
    fun createdAt(): CreatedAtFilter? = createdAt
    ...
    class Builder internal constructor() {
        ...
        private var createdAt: CreatedAtFilter? = null
        ...
        /** Filter by created_at timestamp range in UTC. Accepts gt/gte/lt/lte. */
        fun createdAt(createdAt: CreatedAtFilter?) = apply { this.createdAt = createdAt }
    ...
    private constructor(
        ...
        companion object {
            ...
            /** Returns a mutable builder for constructing an instance of [CreatedAtFilter]. */
            fun builder() = Builder()
        }

        /** A builder for [CreatedAtFilter]. */
        class Builder internal constructor() {
            ...
            internal fun from(createdAtFilter: CreatedAtFilter) = apply {
                gt = createdAtFilter.gt
                gte = createdAtFilter.gte
                lt = createdAtFilter.lt
                lte = createdAtFilter.lte
                additionalProperties = createdAtFilter.additionalProperties.toBuilder()
            }
            ...
            /**
             * Returns an immutable instance of [CreatedAtFilter].
             *
             * Further updates to this [Builder] will not mutate the returned instance.
             */
            fun build(): CreatedAtFilter =
                CreatedAtFilter(gt, gte, lt, lte, additionalProperties.build())
        }
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is CreatedAtFilter &&
                gt == other.gt &&
                gte == other.gte &&
                lt == other.lt &&
                lte == other.lte &&
        ...
        override fun toString() =
            "CreatedAtFilter{gt=$gt, gte=$gte, lt=$lt, lte=$lte, additionalProperties=$additionalProperties}"
    }
