...
private constructor(
     ...
     */
    fun lastOrder(): LastOrder? = lastOrder.getNullable("last_order")
     ...
     */
    @JsonProperty("last_order") @ExcludeMissing fun _lastOrder(): JsonField<LastOrder> = lastOrder
    ...
    class Builder internal constructor() {
        ...
        fun lastOrder(lastOrder: LastOrder) = lastOrder(JsonField.of(lastOrder))

        /**
         * Sets [Builder.lastOrder] to an arbitrary JSON value.
         *
         * You should usually call [Builder.lastOrder] with a well-typed [LastOrder] value instead.
    ...
    private constructor(
         ...
         * ```kotlin
         * val myObject: MyClass = lastOrder.relatedCategory().convert(MyClass::class.java)
         * ```
         */
        @JsonProperty("relatedCategory")
        @ExcludeMissing
         ...
         * This arbitrary value can be deserialized into a custom type using the `convert` method:
         * ```kotlin
         * val myObject: MyClass = lastOrder.relatedCustomer().convert(MyClass::class.java)
         * ```
         */
        @JsonProperty("relatedCustomer")
        @ExcludeMissing
         ...
         * This arbitrary value can be deserialized into a custom type using the `convert` method:
         * ```kotlin
         * val myObject: MyClass = lastOrder.relatedShelter().convert(MyClass::class.java)
         * ```
         */
        @JsonProperty("relatedShelter")
        @ExcludeMissing
         ...
         * This arbitrary value can be deserialized into a custom type using the `convert` method:
         * ```kotlin
         * val myObject: MyClass = lastOrder.relatedTag().convert(MyClass::class.java)
         * ```
         */
         ...
         * This arbitrary value can be deserialized into a custom type using the `convert` method:
         * ```kotlin
         * val myObject: MyClass = lastOrder.relatedUser().convert(MyClass::class.java)
         * ```
         */
        ...
        companion object {
            ...
            /** Returns a mutable builder for constructing an instance of [LastOrder]. */
            fun builder() = Builder()
        }

        /** A builder for [LastOrder]. */
        class Builder internal constructor() {
            ...
            internal fun from(lastOrder: LastOrder) = apply {
                id = lastOrder.id
                complete = lastOrder.complete
                petId = lastOrder.petId
                quantity = lastOrder.quantity
                relatedAddress = lastOrder.relatedAddress
                relatedCategory = lastOrder.relatedCategory
                relatedCustomer = lastOrder.relatedCustomer
                relatedMoney = lastOrder.relatedMoney
                relatedPet = lastOrder.relatedPet
                relatedShelter = lastOrder.relatedShelter
                relatedTag = lastOrder.relatedTag
                relatedUser = lastOrder.relatedUser
            ...
            /**
             * Returns an immutable instance of [LastOrder].
             *
             * Further updates to this [Builder] will not mutate the returned instance.
             */
            fun build(): LastOrder =
