...
private constructor(
    private val pong: PetServerPongEvent? = null,
    private val status: PetServerStatusEvent? = null,
    private val _json: JsonValue? = null,
) {

    fun pong(): PetServerPongEvent? = pong

    fun status(): PetServerStatusEvent? = status

    fun isPong(): Boolean = pong != null

    fun isStatus(): Boolean = status != null

    fun asPong(): PetServerPongEvent = pong.getOrThrow("pong")

    fun asStatus(): PetServerStatusEvent = status.getOrThrow("status")
     ...
     *     override fun visitPong(pong: PetServerPongEvent): String? = pong.toString()
     *
     *     // ...
     *
    ...
    fun validate(): ConnectServerEvent = apply {
        ...
        accept(
            object : Visitor<Unit> {
                override fun visitPong(pong: PetServerPongEvent) {
                    pong.validate()
                }

                override fun visitStatus(status: PetServerStatusEvent) {
                    status.validate()
                }
            }
        )
    ...
    internal fun validity(): Int =
        accept(
            object : Visitor<Int> {
                override fun visitPong(pong: PetServerPongEvent) = pong.validity()

                override fun visitStatus(status: PetServerStatusEvent) = status.validity()
    ...
    companion object {
        ...
        fun ofPong(pong: PetServerPongEvent) = ConnectServerEvent(pong = pong)

        fun ofStatus(status: PetServerStatusEvent) = ConnectServerEvent(status = status)
    }
    ...
    interface Visitor<out T> {
        ...
        fun visitPong(pong: PetServerPongEvent): T

        fun visitStatus(status: PetServerStatusEvent): T
    ...
    internal class Deserializer : BaseDeserializer<ConnectServerEvent>(ConnectServerEvent::class) {
        ...
        override fun ObjectCodec.deserialize(node: JsonNode): ConnectServerEvent {
            ...
            when (type) {
                "pong" -> {
                    return tryDeserialize(node, jacksonTypeRef<PetServerPongEvent>())?.let {
                        ConnectServerEvent(pong = it, _json = json)
                    } ?: ConnectServerEvent(_json = json)
                }
                "status" -> {
                    return tryDeserialize(node, jacksonTypeRef<PetServerStatusEvent>())?.let {
    ...
    private constructor(
        ...
        companion object {
            ...
            /**
             * Returns a mutable builder for constructing an instance of [PetServerPongEvent].
             *
        ...
        /** A builder for [PetServerPongEvent]. */
        class Builder internal constructor() {

            private var type: JsonField<Type>? = null
            private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

            internal fun from(petServerPongEvent: PetServerPongEvent) = apply {
                type = petServerPongEvent.type
                additionalProperties = petServerPongEvent.additionalProperties.toMutableMap()
            }
            ...
            /**
             * Returns an immutable instance of [PetServerPongEvent].
             *
             ...
             */
            fun build(): PetServerPongEvent =
                PetServerPongEvent(checkRequired("type", type), additionalProperties.toMutableMap())
        }
         ...
         *   match its expected type.
         */
        fun validate(): PetServerPongEvent = apply {
            if (validated) {
                return@apply
            }
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is PetServerPongEvent &&
                type == other.type &&
        ...
        override fun toString() =
            "PetServerPongEvent{type=$type, additionalProperties=$additionalProperties}"
    }

    class PetServerStatusEvent
    @JsonCreator(mode = JsonCreator.Mode.DISABLED)
    private constructor(
        ...
        companion object {
            ...
            /**
             * Returns a mutable builder for constructing an instance of [PetServerStatusEvent].
             *
             * The following fields are required:
             * ```kotlin
             * .pet()
        ...
        /** A builder for [PetServerStatusEvent]. */
        class Builder internal constructor() {
            ...
            internal fun from(petServerStatusEvent: PetServerStatusEvent) = apply {
                pet = petServerStatusEvent.pet
                type = petServerStatusEvent.type
                additionalProperties = petServerStatusEvent.additionalProperties.toMutableMap()
            }
            ...
            /**
             * Returns an immutable instance of [PetServerStatusEvent].
             *
             * Further updates to this [Builder] will not mutate the returned instance.
             *
             * The following fields are required:
             ...
             * @throws IllegalStateException if any required field is unset.
             */
            fun build(): PetServerStatusEvent =
                PetServerStatusEvent(
         ...
         *   match its expected type.
         */
        fun validate(): PetServerStatusEvent = apply {
            if (validated) {
                return@apply
            }
         ...
         */
        internal fun validity(): Int =
            (pet.asKnown()?.validity() ?: 0) + (type.asKnown()?.validity() ?: 0)
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is PetServerStatusEvent &&
                pet == other.pet &&
                type == other.type &&
                additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() =
            "PetServerStatusEvent{pet=$pet, type=$type, additionalProperties=$additionalProperties}"
    }
}
