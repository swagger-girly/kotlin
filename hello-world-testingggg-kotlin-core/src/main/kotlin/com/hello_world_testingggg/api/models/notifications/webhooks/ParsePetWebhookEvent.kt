...
@JsonDeserialize(using = ParsePetWebhookEvent.Deserializer::class)
@JsonSerialize(using = ParsePetWebhookEvent.Serializer::class)
class ParsePetWebhookEvent
private constructor(
     ...
     * import com.hello_world_testingggg.api.core.JsonValue
     *
     * val result: String? = parsePetWebhookEvent.accept(object : ParsePetWebhookEvent.Visitor<String?> {
     ...
     */
    fun validate(): ParsePetWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ParsePetWebhookEvent &&
    ...
    override fun toString(): String =
        when {
            petCreated != null -> "ParsePetWebhookEvent{petCreated=$petCreated}"
            petUpdated != null -> "ParsePetWebhookEvent{petUpdated=$petUpdated}"
            petInventoryLow != null -> "ParsePetWebhookEvent{petInventoryLow=$petInventoryLow}"
            petModerationApproved != null ->
                "ParsePetWebhookEvent{petModerationApproved=$petModerationApproved}"
            petModerationRejected != null ->
                "ParsePetWebhookEvent{petModerationRejected=$petModerationRejected}"
            _json != null -> "ParsePetWebhookEvent{_unknown=$_json}"
            else -> throw IllegalStateException("Invalid ParsePetWebhookEvent")
        }

    companion object {

        fun ofPetCreated(petCreated: PetCreatedWebhookEvent) =
            ParsePetWebhookEvent(petCreated = petCreated)

        fun ofPetUpdated(petUpdated: PetUpdatedWebhookEvent) =
            ParsePetWebhookEvent(petUpdated = petUpdated)

        fun ofPetInventoryLow(petInventoryLow: PetInventoryLowWebhookEvent) =
            ParsePetWebhookEvent(petInventoryLow = petInventoryLow)
    ...
    /**
     * An interface that defines how to map each variant of [ParsePetWebhookEvent] to a value of
     * type [T].
     */
    interface Visitor<out T> {
        ...
        /**
         * Maps an unknown variant of [ParsePetWebhookEvent] to a value of type [T].
         *
         * An instance of [ParsePetWebhookEvent] can contain an unknown variant if it was
        ...
        fun unknown(json: JsonValue?): T {
            throw HelloWorldTestinggggInvalidDataException("Unknown ParsePetWebhookEvent: $json")
        }
    }

    internal class Deserializer :
        BaseDeserializer<ParsePetWebhookEvent>(ParsePetWebhookEvent::class) {

        override fun ObjectCodec.deserialize(node: JsonNode): ParsePetWebhookEvent {
            val json = JsonValue.fromJsonNode(node)

            val bestMatches =
                sequenceOf(
                        tryDeserialize(node, jacksonTypeRef<PetCreatedWebhookEvent>())?.let {
                            ParsePetWebhookEvent(petCreated = it, _json = json)
                        },
                        tryDeserialize(node, jacksonTypeRef<PetUpdatedWebhookEvent>())?.let {
                            ParsePetWebhookEvent(petUpdated = it, _json = json)
                        },
                        tryDeserialize(node, jacksonTypeRef<PetInventoryLowWebhookEvent>())?.let {
                            ParsePetWebhookEvent(petInventoryLow = it, _json = json)
                        },
                        tryDeserialize(node, jacksonTypeRef<PetModerationApprovedEvent>())?.let {
                            ParsePetWebhookEvent(petModerationApproved = it, _json = json)
                        },
                        tryDeserialize(node, jacksonTypeRef<PetModerationRejectedEvent>())?.let {
                            ParsePetWebhookEvent(petModerationRejected = it, _json = json)
                        },
                    )
                    .filterNotNull()
            ...
            return when (bestMatches.size) {
                ...
                0 -> ParsePetWebhookEvent(_json = json)
    ...
    internal class Serializer : BaseSerializer<ParsePetWebhookEvent>(ParsePetWebhookEvent::class) {

        override fun serialize(
            value: ParsePetWebhookEvent,
    ...
    private constructor(
        ...
        private constructor(
            ...
            private constructor(
                 ...
                 * method:
                 * ```kotlin
                 * val myObject: MyClass = reviewer.relatedCategory().convert(MyClass::class.java)
                 * ```
                 */
                @JsonProperty("relatedCategory")
                @ExcludeMissing
                 ...
                 * method:
                 * ```kotlin
                 * val myObject: MyClass = reviewer.relatedCustomer().convert(MyClass::class.java)
                 * ```
                 */
                @JsonProperty("relatedCustomer")
                @ExcludeMissing
                 ...
                 * method:
                 * ```kotlin
                 * val myObject: MyClass = reviewer.relatedOrder().convert(MyClass::class.java)
                 * ```
                 */
                @JsonProperty("relatedOrder")
                @ExcludeMissing
                 ...
                 * method:
                 * ```kotlin
                 * val myObject: MyClass = reviewer.relatedShelter().convert(MyClass::class.java)
                 * ```
                 */
                @JsonProperty("relatedShelter")
                @ExcludeMissing
                 ...
                 * method:
                 * ```kotlin
                 * val myObject: MyClass = reviewer.relatedTag().convert(MyClass::class.java)
                 * ```
                 */
                @JsonProperty("relatedTag")
                @ExcludeMissing
                ...
                class Builder internal constructor() {
                    ...
                    internal fun from(reviewer: Reviewer) = apply {
                        ...
                        relatedAddress = reviewer.relatedAddress
                        relatedCategory = reviewer.relatedCategory
                        relatedCustomer = reviewer.relatedCustomer
                        relatedMoney = reviewer.relatedMoney
                        relatedOrder = reviewer.relatedOrder
                        relatedPet = reviewer.relatedPet
                        relatedShelter = reviewer.relatedShelter
                        relatedTag = reviewer.relatedTag
