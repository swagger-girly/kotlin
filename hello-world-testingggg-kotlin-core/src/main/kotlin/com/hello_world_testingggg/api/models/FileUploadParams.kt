...
private constructor(
    private val body: FileUploadRequest,
    ...
    class Builder internal constructor() {
        ...
        private var body: FileUploadRequest.Builder = FileUploadRequest.builder()
         ...
         * - etc.
         */
        fun body(body: FileUploadRequest) = apply { this.body = body.toBuilder() }
    ...
    private constructor(
        ...
        companion object {
            ...
            /**
             * Returns a mutable builder for constructing an instance of [FileUploadRequest].
             *
             * The following fields are required:
             * ```kotlin
             * .file()
        ...
        /** A builder for [FileUploadRequest]. */
        class Builder internal constructor() {
            ...
            internal fun from(fileUploadRequest: FileUploadRequest) = apply {
                file = fileUploadRequest.file
                expiresIn = fileUploadRequest.expiresIn
                metadata = fileUploadRequest.metadata
                path = fileUploadRequest.path
                public_ = fileUploadRequest.public_
                tags = fileUploadRequest.tags.map { it.toMutableList() }
                additionalProperties = fileUploadRequest.additionalProperties.toMutableMap()
            }
            ...
            /**
             * Returns an immutable instance of [FileUploadRequest].
             *
             * Further updates to this [Builder] will not mutate the returned instance.
             *
             * The following fields are required:
         ...
         */
        fun validate(): FileUploadRequest = apply {
            if (validated) {
                return@apply
            }
        ...
        override fun toString() =
            "FileUploadRequest{file=$file, expiresIn=$expiresIn, metadata=$metadata, path=$path, public_=$public_, tags=$tags, additionalProperties=$additionalProperties}"
    }
