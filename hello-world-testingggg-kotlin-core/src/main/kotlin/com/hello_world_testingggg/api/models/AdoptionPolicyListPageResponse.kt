...
class AdoptionPolicyListPageResponse
...
private constructor(
    ...
    companion object {
         ...
         * [AdoptionPolicyListPageResponse].
         *
    ...
    /** A builder for [AdoptionPolicyListPageResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(adoptionPolicyListPageResponse: AdoptionPolicyListPageResponse) = apply {
            items = adoptionPolicyListPageResponse.items.map { it.toMutableList() }
            nextCursor = adoptionPolicyListPageResponse.nextCursor
            additionalProperties =
                adoptionPolicyListPageResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AdoptionPolicyListPageResponse].
         *
         ...
         */
        fun build(): AdoptionPolicyListPageResponse =
            AdoptionPolicyListPageResponse(
     ...
     */
    fun validate(): AdoptionPolicyListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AdoptionPolicyListPageResponse &&
            items == other.items &&
    ...
    override fun toString() =
        "AdoptionPolicyListPageResponse{items=$items, nextCursor=$nextCursor, additionalProperties=$additionalProperties}"
}
