...
private constructor(
    ...
    override fun toString() =
        "OrderRetrieveResponse{id=$id, complete=$complete, petId=$petId, quantity=$quantity, shipDate=$shipDate, status=$status, total=$total, additionalProperties=$additionalProperties}"
}
