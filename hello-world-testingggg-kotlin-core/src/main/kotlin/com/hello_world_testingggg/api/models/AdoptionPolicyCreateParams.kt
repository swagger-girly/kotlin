 ...
 */
class AdoptionPolicyCreateParams
private constructor(
    private val body: AdoptionPolicyCreateRequest,
     ...
     */
    fun escalation(): RuleGroup? = body.escalation()
     ...
     */
    fun _escalation(): JsonField<RuleGroup> = body._escalation()
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AdoptionPolicyCreateParams].
         *
    ...
    /** A builder for [AdoptionPolicyCreateParams]. */
    class Builder internal constructor() {

        private var body: AdoptionPolicyCreateRequest.Builder =
            AdoptionPolicyCreateRequest.builder()
        private var additionalHeaders: Headers.Builder = Headers.builder()
        private var additionalQueryParams: QueryParams.Builder = QueryParams.builder()

        internal fun from(adoptionPolicyCreateParams: AdoptionPolicyCreateParams) = apply {
            body = adoptionPolicyCreateParams.body.toBuilder()
            additionalHeaders = adoptionPolicyCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = adoptionPolicyCreateParams.additionalQueryParams.toBuilder()
        }
         ...
         * - etc.
         */
        fun body(body: AdoptionPolicyCreateRequest) = apply { this.body = body.toBuilder() }
        ...
        fun escalation(escalation: RuleGroup) = apply { body.escalation(escalation) }
         ...
         * value.
         */
        fun escalation(escalation: JsonField<RuleGroup>) = apply { body.escalation(escalation) }
        ...
        /**
         * Returns an immutable instance of [AdoptionPolicyCreateParams].
         *
         ...
         */
        fun build(): AdoptionPolicyCreateParams =
            AdoptionPolicyCreateParams(
                body.build(),
    ...
    fun _body(): AdoptionPolicyCreateRequest = body

    override fun _headers(): Headers = additionalHeaders

    override fun _queryParams(): QueryParams = additionalQueryParams

    class AdoptionPolicyCreateRequest
    ...
    private constructor(
        ...
        @JsonProperty("escalation")
        @ExcludeMissing
        fun _escalation(): JsonField<RuleGroup> = escalation
        ...
        /** A builder for [AdoptionPolicyCreateRequest]. */
        class Builder internal constructor() {
            ...
            internal fun from(adoptionPolicyCreateRequest: AdoptionPolicyCreateRequest) = apply {
                name = adoptionPolicyCreateRequest.name
                rules = adoptionPolicyCreateRequest.rules.map { it.toMutableList() }
                escalation = adoptionPolicyCreateRequest.escalation
                feeCap = adoptionPolicyCreateRequest.feeCap
                notificationTarget = adoptionPolicyCreateRequest.notificationTarget
                regionalOverrides = adoptionPolicyCreateRequest.regionalOverrides
                additionalProperties =
                    adoptionPolicyCreateRequest.additionalProperties.toMutableMap()
            }
             ...
             * Sets [Builder.escalation] to an arbitrary JSON value.
             *
             * You should usually call [Builder.escalation] with a well-typed [RuleGroup] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun escalation(escalation: JsonField<RuleGroup>) = apply {
            ...
            /**
             * Returns an immutable instance of [AdoptionPolicyCreateRequest].
             *
             * Further updates to this [Builder] will not mutate the returned instance.
             *
             * The following fields are required:
             ...
             * @throws IllegalStateException if any required field is unset.
             */
            fun build(): AdoptionPolicyCreateRequest =
                AdoptionPolicyCreateRequest(
         ...
         */
        fun validate(): AdoptionPolicyCreateRequest = apply {
            if (validated) {
                return@apply
            }
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is AdoptionPolicyCreateRequest &&
                name == other.name &&
                rules == other.rules &&
        ...
        override fun toString() =
            "AdoptionPolicyCreateRequest{name=$name, rules=$rules, escalation=$escalation, feeCap=$feeCap, notificationTarget=$notificationTarget, regionalOverrides=$regionalOverrides, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AdoptionPolicyCreateParams &&
            body == other.body &&
    ...
    override fun toString() =
        "AdoptionPolicyCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
