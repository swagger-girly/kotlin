...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): PetListParams =
            PetListParams(cursor, limit, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "PetListParams{cursor=$cursor, limit=$limit, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
