...
private constructor(
    ...
    ) : this(id, createdAt, status, completedAt, filters, totals, mutableMapOf())
     ...
     *   (e.g. if the server responded with an unexpected value).
     */
    fun totals(): Totals? = totals.getNullable("totals")
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             * Further updates to this [Builder] will not mutate the returned instance.
             */
            fun build(): Totals = Totals(additionalProperties.toImmutable())
        }
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is Totals && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "Totals{additionalProperties=$additionalProperties}"
    }
    ...
    private val hashCode: Int by lazy {
        Objects.hash(id, createdAt, status, completedAt, filters, totals, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "Report{id=$id, createdAt=$createdAt, status=$status, completedAt=$completedAt, filters=$filters, totals=$totals, additionalProperties=$additionalProperties}"
}
