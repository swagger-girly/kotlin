...
private constructor(
    private val data: JsonField<List<StoreReportInventoryRow>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<StoreReportInventoryRow>> = JsonMissing.of()
     ...
     */
    fun data(): List<StoreReportInventoryRow> = data.getRequired("data")
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<StoreReportInventoryRow>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<StoreReportInventoryRow>>? = null
        ...
        fun data(data: List<StoreReportInventoryRow>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<StoreReportInventoryRow>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun data(data: JsonField<List<StoreReportInventoryRow>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [StoreReportInventoryRow] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: StoreReportInventoryRow) = apply {
            this.data =
    ...
    private constructor(
        ...
        companion object {
            ...
            /**
             * Returns a mutable builder for constructing an instance of [StoreReportInventoryRow].
             *
             * The following fields are required:
             * ```kotlin
             * .quantity()
        ...
        /** A builder for [StoreReportInventoryRow]. */
        class Builder internal constructor() {
            ...
            internal fun from(storeReportInventoryRow: StoreReportInventoryRow) = apply {
                quantity = storeReportInventoryRow.quantity
                sku = storeReportInventoryRow.sku
                attributes = storeReportInventoryRow.attributes
                petId = storeReportInventoryRow.petId
                additionalProperties = storeReportInventoryRow.additionalProperties.toMutableMap()
            }
            ...
            /**
             * Returns an immutable instance of [StoreReportInventoryRow].
             *
             * Further updates to this [Builder] will not mutate the returned instance.
             *
             * The following fields are required:
             ...
             * @throws IllegalStateException if any required field is unset.
             */
            fun build(): StoreReportInventoryRow =
         ...
         *   match its expected type.
         */
        fun validate(): StoreReportInventoryRow = apply {
            if (validated) {
                return@apply
            }
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is StoreReportInventoryRow &&
        ...
        override fun toString() =
            "StoreReportInventoryRow{quantity=$quantity, sku=$sku, attributes=$attributes, petId=$petId, additionalProperties=$additionalProperties}"
    }
