...
private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("audit") @ExcludeMissing audit: JsonField<AuditStamp> = JsonMissing.of(),
    ...
    class Builder internal constructor() {
         ...
         *
         * You should usually call [Builder.audit] with a well-typed [AuditStamp] value instead.
