...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PetCreatedWebhookEvent].
         *
    ...
    /** A builder for [PetCreatedWebhookEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(petCreatedWebhookEvent: PetCreatedWebhookEvent) = apply {
            pet = petCreatedWebhookEvent.pet
            type = petCreatedWebhookEvent.type
            additionalProperties = petCreatedWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PetCreatedWebhookEvent].
         *
         ...
         */
        fun build(): PetCreatedWebhookEvent =
     ...
     */
    fun validate(): PetCreatedWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            val PET_CREATED = of("pet.created")
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PetCreatedWebhookEvent &&
            pet == other.pet &&
            type == other.type &&
    ...
    override fun toString() =
        "PetCreatedWebhookEvent{pet=$pet, type=$type, additionalProperties=$additionalProperties}"
}
