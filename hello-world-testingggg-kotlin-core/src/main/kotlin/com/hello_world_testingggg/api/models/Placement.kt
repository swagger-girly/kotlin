...
private constructor(
    ...
    private constructor(
        ...
        private constructor(
             ...
             */
            internal fun validity(): Int =
                (if (body.asKnown() == null) 0 else 1) + (kind.asKnown()?.validity() ?: 0)
                ...
                fun known(): Known =
                    when (this) {
                        NOTE -> Known.NOTE
                            ...
                            throw HelloWorldTestinggggInvalidDataException("Unknown Kind: $value")
                    }
        ...
        private constructor(
             ...
             */
            internal fun validity(): Int =
                (if (adoptedAt.asKnown() == null) 0 else 1) + (kind.asKnown()?.validity() ?: 0)
        ...
        private constructor(
             ...
             */
            internal fun validity(): Int =
                (kind.asKnown()?.validity() ?: 0) + (if (reason.asKnown() == null) 0 else 1)
