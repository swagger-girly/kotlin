...
/** @see PlacementService.list */
class PlacementListPage
private constructor(
    private val service: PlacementService,
    ...
    override fun nextPage(): PlacementListPage = service.list(nextPageParams())

    fun autoPager(): AutoPager<Placement> = AutoPager.from(this)
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PlacementListPage].
         *
    ...
    /** A builder for [PlacementListPage]. */
    class Builder internal constructor() {

        private var service: PlacementService? = null
        private var params: PlacementListParams? = null
        private var response: PlacementListPageResponse? = null

        internal fun from(placementListPage: PlacementListPage) = apply {
            service = placementListPage.service
            params = placementListPage.params
            response = placementListPage.response
        }

        fun service(service: PlacementService) = apply { this.service = service }
        ...
        /**
         * Returns an immutable instance of [PlacementListPage].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PlacementListPage &&
    ...
    override fun toString() =
        "PlacementListPage{service=$service, params=$params, response=$response}"
}
