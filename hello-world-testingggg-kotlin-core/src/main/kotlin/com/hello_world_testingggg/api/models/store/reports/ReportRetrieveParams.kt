...
private constructor(
    ...
    companion object {
        ...
        fun none(): ReportRetrieveParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(reportRetrieveParams: ReportRetrieveParams) = apply {
            reportId = reportRetrieveParams.reportId
        ...
        fun build(): ReportRetrieveParams =
            ReportRetrieveParams(reportId, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "ReportRetrieveParams{reportId=$reportId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
