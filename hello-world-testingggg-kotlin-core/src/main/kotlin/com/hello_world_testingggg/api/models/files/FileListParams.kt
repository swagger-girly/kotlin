...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): FileListParams =
            FileListParams(additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "FileListParams{additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
