...
class StoreOrderCreateParams
private constructor(
    private val body: Order,
     ...
     * ```kotlin
     * val myObject: MyClass = storeOrderCreateParams.relatedCategory().convert(MyClass::class.java)
     * ```
     */
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```kotlin
     * val myObject: MyClass = storeOrderCreateParams.relatedCustomer().convert(MyClass::class.java)
     * ```
     */
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```kotlin
     * val myObject: MyClass = storeOrderCreateParams.relatedShelter().convert(MyClass::class.java)
     * ```
     */
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```kotlin
     * val myObject: MyClass = storeOrderCreateParams.relatedTag().convert(MyClass::class.java)
     * ```
     */
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```kotlin
     * val myObject: MyClass = storeOrderCreateParams.relatedUser().convert(MyClass::class.java)
     * ```
     */
     ...
     */
    fun _total(): JsonField<Money> = body._total()
    ...
    companion object {
        ...
        fun none(): StoreOrderCreateParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [StoreOrderCreateParams]. */
        fun builder() = Builder()
    }

    /** A builder for [StoreOrderCreateParams]. */
    class Builder internal constructor() {

        private var body: Order.Builder = Order.builder()
        private var additionalHeaders: Headers.Builder = Headers.builder()
        private var additionalQueryParams: QueryParams.Builder = QueryParams.builder()

        internal fun from(storeOrderCreateParams: StoreOrderCreateParams) = apply {
            body = storeOrderCreateParams.body.toBuilder()
            additionalHeaders = storeOrderCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = storeOrderCreateParams.additionalQueryParams.toBuilder()
        }
         ...
         * - etc.
         */
        fun body(body: Order) = apply { this.body = body.toBuilder() }
        ...
        fun total(total: Money) = apply { body.total(total) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun total(total: JsonField<Money>) = apply { body.total(total) }
        ...
        /**
         * Returns an immutable instance of [StoreOrderCreateParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): StoreOrderCreateParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is StoreOrderCreateParams &&
            body == other.body &&
    ...
    override fun toString() =
        "StoreOrderCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
