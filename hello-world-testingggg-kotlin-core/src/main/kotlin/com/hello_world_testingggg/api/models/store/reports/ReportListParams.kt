...
private constructor(
    ...
    companion object {
        ...
        fun none(): ReportListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(reportListParams: ReportListParams) = apply {
            endingBefore = reportListParams.endingBefore
            pageSize = reportListParams.pageSize
            startingAfter = reportListParams.startingAfter
    ...
    override fun toString() =
        "ReportListParams{endingBefore=$endingBefore, pageSize=$pageSize, startingAfter=$startingAfter, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
