...
class ClientRetrieveRateLimitsResponse
...
private constructor(
    ...
    /** A builder for [ClientRetrieveRateLimitsResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(clientRetrieveRateLimitsResponse: ClientRetrieveRateLimitsResponse) =
            apply {
                remaining = clientRetrieveRateLimitsResponse.remaining
                resetAt = clientRetrieveRateLimitsResponse.resetAt
                tiers = clientRetrieveRateLimitsResponse.tiers.map { it.toMutableList() }
                additionalProperties =
                    clientRetrieveRateLimitsResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [ClientRetrieveRateLimitsResponse].
         *
         ...
         */
        fun build(): ClientRetrieveRateLimitsResponse =
            ClientRetrieveRateLimitsResponse(
     ...
     */
    fun validate(): ClientRetrieveRateLimitsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ClientRetrieveRateLimitsResponse &&
    ...
    override fun toString() =
        "ClientRetrieveRateLimitsResponse{remaining=$remaining, resetAt=$resetAt, tiers=$tiers, additionalProperties=$additionalProperties}"
}
