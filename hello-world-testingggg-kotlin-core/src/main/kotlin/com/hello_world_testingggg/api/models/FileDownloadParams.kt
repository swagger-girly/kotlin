...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): FileDownloadParams =
            FileDownloadParams(path, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun hashCode(): Int = Objects.hash(path, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "FileDownloadParams{path=$path, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
