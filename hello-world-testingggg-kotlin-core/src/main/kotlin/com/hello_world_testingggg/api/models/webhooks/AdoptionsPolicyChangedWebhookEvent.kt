...
class AdoptionsPolicyChangedWebhookEvent
...
private constructor(
    ...
    ) : this(id, createdAt, policy, type, previous, mutableMapOf())
     ...
     * ```kotlin
     * JsonValue.from("adoptions.policy.changed")
     * ```
     *
     ...
     */
    fun previous(): Previous? = previous.getNullable("previous")
    ...
    /** A builder for [AdoptionsPolicyChangedWebhookEvent]. */
    class Builder internal constructor() {

        private var id: JsonField<String>? = null
        private var createdAt: JsonField<OffsetDateTime>? = null
        private var policy: JsonField<Policy>? = null
        private var type: JsonValue = JsonValue.from("adoptions.policy.changed")
        private var previous: JsonField<Previous> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(adoptionsPolicyChangedWebhookEvent: AdoptionsPolicyChangedWebhookEvent) =
            apply {
                id = adoptionsPolicyChangedWebhookEvent.id
                createdAt = adoptionsPolicyChangedWebhookEvent.createdAt
                policy = adoptionsPolicyChangedWebhookEvent.policy
                type = adoptionsPolicyChangedWebhookEvent.type
                previous = adoptionsPolicyChangedWebhookEvent.previous
                additionalProperties =
                    adoptionsPolicyChangedWebhookEvent.additionalProperties.toMutableMap()
            }
         ...
         *
         * You should usually call [Builder.previous] with a well-typed [Previous] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        ...
        /**
         * Returns an immutable instance of [AdoptionsPolicyChangedWebhookEvent].
         *
         ...
         */
        fun build(): AdoptionsPolicyChangedWebhookEvent =
            AdoptionsPolicyChangedWebhookEvent(
                checkRequired("id", id),
     ...
     */
    fun validate(): AdoptionsPolicyChangedWebhookEvent = apply {
        if (validated) {
            return@apply
        }
        ...
        policy().validate()
        _type().let {
            if (it != JsonValue.from("adoptions.policy.changed")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown() == null) 0 else 1) +
            ...
            type.let { if (it == JsonValue.from("adoptions.policy.changed")) 1 else 0 } +
            (previous.asKnown()?.validity() ?: 0)
    ...
    private constructor(
        ...
        ) : this(notificationTarget, status, mutableMapOf())
        ...
        class Builder internal constructor() {
            ...
            internal fun from(previous: Previous) = apply {
                notificationTarget = previous.notificationTarget
             ...
             */
            fun build(): Previous =
                Previous(notificationTarget, status, additionalProperties.toMutableMap())
        }
         ...
         */
        internal fun validity(): Int =
            (notificationTarget.asKnown()?.validity() ?: 0) + (status.asKnown()?.validity() ?: 0)
        ...
        private constructor(
            ...
            /**
             * An interface that defines how to map each variant of [NotificationTarget] to a value
             * of type [T].
             */
            ...
            private constructor(
                 ...
                 *
                 * Unlike [events], this method doesn't throw if the JSON field has an unexpected
                 * type.
                 */
                @JsonProperty("events")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [secret], this method doesn't throw if the JSON field has an unexpected
                 * type.
                 */
        ...
        private val hashCode: Int by lazy {
            Objects.hash(notificationTarget, status, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Previous{notificationTarget=$notificationTarget, status=$status, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AdoptionsPolicyChangedWebhookEvent &&
            id == other.id &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(id, createdAt, policy, type, previous, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "AdoptionsPolicyChangedWebhookEvent{id=$id, createdAt=$createdAt, policy=$policy, type=$type, previous=$previous, additionalProperties=$additionalProperties}"
}
