...
private constructor(
    private val body: PlacementCreateRequest,
     ...
     *   (e.g. if the server responded with an unexpected value).
     */
    fun logistics(): PlacementLogistics? = body.logistics()
     ...
     */
    fun _logistics(): JsonField<PlacementLogistics> = body._logistics()
    ...
    class Builder internal constructor() {
        ...
        private var body: PlacementCreateRequest.Builder = PlacementCreateRequest.builder()
         ...
         * - [scheduledFor]
         */
        fun body(body: PlacementCreateRequest) = apply { this.body = body.toBuilder() }
        ...
        /** Transport plan for a placement; pickup and delivery share the transfer-leg shape. */
        fun logistics(logistics: PlacementLogistics) = apply { body.logistics(logistics) }

        /**
         * Sets [Builder.logistics] to an arbitrary JSON value.
         *
         * You should usually call [Builder.logistics] with a well-typed [PlacementLogistics] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun logistics(logistics: JsonField<PlacementLogistics>) = apply {
    ...
    private constructor(
        ...
        private constructor(
            ...
            @ExcludeMissing
            logistics: JsonField<PlacementLogistics> = JsonMissing.of(),
         ...
         *   (e.g. if the server responded with an unexpected value).
         */
        fun logistics(): PlacementLogistics? = logistics.getNullable("logistics")
        ...
        @JsonProperty("logistics")
        @ExcludeMissing
        fun _logistics(): JsonField<PlacementLogistics> = logistics
        ...
        companion object {
            ...
            /**
             * Returns a mutable builder for constructing an instance of [PlacementCreateRequest].
             *
             * The following fields are required:
             * ```kotlin
             * .applicationId()
        ...
        /** A builder for [PlacementCreateRequest]. */
        class Builder internal constructor() {

            private var applicationId: JsonField<String>? = null
            private var initialEvent: JsonField<PlacementEvent> = JsonMissing.of()
            private var logistics: JsonField<PlacementLogistics> = JsonMissing.of()
            private var scheduledFor: JsonField<OffsetDateTime> = JsonMissing.of()
            private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

            internal fun from(placementCreateRequest: PlacementCreateRequest) = apply {
                applicationId = placementCreateRequest.applicationId
                initialEvent = placementCreateRequest.initialEvent
                logistics = placementCreateRequest.logistics
                scheduledFor = placementCreateRequest.scheduledFor
                additionalProperties = placementCreateRequest.additionalProperties.toMutableMap()
            }
            ...
            /** Transport plan for a placement; pickup and delivery share the transfer-leg shape. */
            fun logistics(logistics: PlacementLogistics) = logistics(JsonField.of(logistics))

            /**
             * Sets [Builder.logistics] to an arbitrary JSON value.
             *
             * You should usually call [Builder.logistics] with a well-typed [PlacementLogistics]
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
            fun logistics(logistics: JsonField<PlacementLogistics>) = apply {
            ...
            /**
             * Returns an immutable instance of [PlacementCreateRequest].
             *
             * Further updates to this [Builder] will not mutate the returned instance.
             *
             * The following fields are required:
             ...
             * @throws IllegalStateException if any required field is unset.
             */
            fun build(): PlacementCreateRequest =
         ...
         */
        fun validate(): PlacementCreateRequest = apply {
            if (validated) {
                return@apply
            }
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is PlacementCreateRequest &&
        ...
        override fun toString() =
            "PlacementCreateRequest{applicationId=$applicationId, initialEvent=$initialEvent, logistics=$logistics, scheduledFor=$scheduledFor, additionalProperties=$additionalProperties}"
    }

    /** Transport plan for a placement; pickup and delivery share the transfer-leg shape. */
    class PlacementLogistics
    @JsonCreator(mode = JsonCreator.Mode.DISABLED)
    private constructor(
        ...
        companion object {
            ...
            /** Returns a mutable builder for constructing an instance of [PlacementLogistics]. */
            fun builder() = Builder()
        }

        /** A builder for [PlacementLogistics]. */
        class Builder internal constructor() {
            ...
            internal fun from(placementLogistics: PlacementLogistics) = apply {
                delivery = placementLogistics.delivery
                handler = placementLogistics.handler
                pickup = placementLogistics.pickup
                additionalProperties = placementLogistics.additionalProperties.toMutableMap()
            }
            ...
            /**
             * Returns an immutable instance of [PlacementLogistics].
             *
             * Further updates to this [Builder] will not mutate the returned instance.
             */
            fun build(): PlacementLogistics =
                PlacementLogistics(delivery, handler, pickup, additionalProperties.toMutableMap())
        }
         ...
         *   match its expected type.
         */
        fun validate(): PlacementLogistics = apply {
            if (validated) {
                return@apply
            }
        ...
        private constructor(
            ...
            private constructor(
                ...
                private val audit: JsonField<AuditStamp>,
                ...
                private constructor(
                    ...
                    @JsonProperty("audit")
                    @ExcludeMissing
                    audit: JsonField<AuditStamp> = JsonMissing.of(),
                 ...
                 */
                fun audit(): AuditStamp? = audit.getNullable("audit")
                 ...
                 * type.
                 */
                @JsonProperty("audit") @ExcludeMissing fun _audit(): JsonField<AuditStamp> = audit
                ...
                class Builder internal constructor() {
                    ...
                    private var audit: JsonField<AuditStamp> = JsonMissing.of()
                    ...
                    /** Provenance stamp attached to records across unrelated resources. */
                    fun audit(audit: AuditStamp) = audit(JsonField.of(audit))

                    /**
                     * Sets [Builder.audit] to an arbitrary JSON value.
                     *
                     * You should usually call [Builder.audit] with a well-typed [AuditStamp] value
                     * instead. This method is primarily for setting the field to an undocumented or
                     * not yet supported value.
                     */
                    fun audit(audit: JsonField<AuditStamp>) = apply { this.audit = audit }
                ...
                private constructor(
                    ...
                    companion object {
                        ...
                        /**
                         * Returns a mutable builder for constructing an instance of [AuditStamp].
                         *
                         * The following fields are required:
                         * ```kotlin
                         * .recordedAt()
                    ...
                    class Builder internal constructor() {
                        ...
                        internal fun from(auditStamp: AuditStamp) = apply {
                            recordedAt = auditStamp.recordedAt
                            recordedBy = auditStamp.recordedBy
                            source = auditStamp.source
                            additionalProperties = auditStamp.additionalProperties.toMutableMap()
                        }
                        ...
                        /**
                         * Returns an immutable instance of [AuditStamp].
                         *
                         * Further updates to this [Builder] will not mutate the returned instance.
                         *
                         * The following fields are required:
                    ...
                    override fun toString() =
                        "AuditStamp{recordedAt=$recordedAt, recordedBy=$recordedBy, source=$source, additionalProperties=$additionalProperties}"
                }
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is PlacementLogistics &&
        ...
        override fun toString() =
            "PlacementLogistics{delivery=$delivery, handler=$handler, pickup=$pickup, additionalProperties=$additionalProperties}"
    }
