...
import com.hello_world_testingggg.api.core.http.LoggingHttpClient
import com.hello_world_testingggg.api.core.http.PhantomReachableClosingHttpClient
...
private constructor(
     ...
     *
     * Use the one published in `hello-world-testingggg-kotlin-client-okhttp` or implement your own.
     *
    ...
    class Builder internal constructor() {
         ...
         * The HTTP client to use in the SDK.
         *
         * Use the one published in `hello-world-testingggg-kotlin-client-okhttp` or implement your
         * own.
         *
         * This class takes ownership of the client and closes it when closed.
         */
        ...
        fun fromEnv() = apply {
            ...
            (System.getProperty("helloworldtestingggg.baseUrl")
                    ?: System.getenv("HELLO_WORLD_TESTINGGGG_BASE_URL"))
                ?.let { baseUrl(it) }
