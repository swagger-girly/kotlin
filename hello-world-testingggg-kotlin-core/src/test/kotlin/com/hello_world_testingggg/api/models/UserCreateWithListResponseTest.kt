...
internal class UserCreateWithListResponseTest {
    ...
    fun create() {
        ...
        assertThat(userCreateWithListResponse.relatedAddress())
            .isEqualTo(
                Address.builder()
                    .city("Palo Alto")
        ...
        assertThat(userCreateWithListResponse.relatedMoney())
            .isEqualTo(
                Money.builder()
                    .amount(2500L)
                    .currency("USD")
        ...
        assertThat(userCreateWithListResponse.relatedPet())
            .isEqualTo(
                Pet.builder()
                    .name("doggie")
                    .addPhotoUrl("string")
