                ...
                PlacementCreateParams.Logistics.builder()
                    ...
                    .handler(
                        PlacementCreateParams.Logistics.Handler.builder()
                            .certification(
                                PlacementCreateParams.Logistics.Handler.Certification.builder()
                                    .level(
                                        PlacementCreateParams.Logistics.Handler.Certification.Level
                                            .STANDARD
                                    )
                                    .audit(
                                        PlacementCreateParams.Logistics.Handler.Certification.Audit
                                            .builder()
                                            .recordedAt(
