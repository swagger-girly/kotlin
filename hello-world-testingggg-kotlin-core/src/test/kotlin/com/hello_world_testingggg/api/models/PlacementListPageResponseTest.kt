                    ...
                    Placement.builder()
                        ...
                        .application(
                            Application.builder()
                                .id("id")
                                .applicant(
                                    Application.Applicant.IndividualApplicant.builder()
                                        .applicantType(
                                            Application.Applicant.IndividualApplicant.ApplicantType
                                                .INDIVIDUAL
                                        )
                                        .name("name")
                                        .address(
                                ...
                                .decision(
                                    Application.Decision.DecisionApproved.builder()
                                        ...
                                        .outcome(
                                            Application.Decision.DecisionApproved.Outcome.APPROVED
                                        )
                                        .addCondition("string")
                                        .build()
                                )
                                ...
                                .latestRejection(
                                    Application.DecisionRejected.builder()
                                        .outcome(Application.DecisionRejected.Outcome.REJECTED)
                                        .reason(Application.DecisionRejected.Reason.POLICY)
                                        .appealDeadline(
                                            OffsetDateTime.parse("2019-12-27T18:11:19.117Z")
                                        )
                                        .build()
                        ...
                        .logistics(
                            Placement.PlacementLogistics.builder()
                                .delivery(
                                    TransferLeg.builder()
                                        .location(
                                            Address.builder()
                                ...
                                .handler(
                                    Placement.PlacementLogistics.Handler.builder()
                                        .certification(
                                            Placement.PlacementLogistics.Handler.Certification
                                                .builder()
                                                .level(
                                                    Placement.PlacementLogistics.Handler
                                                        .Certification
                                                        .Level
                                                        .STANDARD
                                                )
                        ...
                        .medicalClearance(
                            MedicalSummary.builder()
                                .petId(0L)
                                .audit(
                                    MedicalSummary.AuditStamp.builder()
                                        .recordedAt(
                                            OffsetDateTime.parse("2019-12-27T18:11:19.117Z")
                                        )
                                        .recordedBy("recordedBy")
                                        .source(MedicalSummary.AuditStamp.Source.MANUAL)
                                        .build()
                                )
                                .addCondition(
                    ...
                    .logistics(
                        Placement.PlacementLogistics.builder()
                            ...
                            .handler(
                                Placement.PlacementLogistics.Handler.builder()
                                    .certification(
                                        Placement.PlacementLogistics.Handler.Certification.builder()
                                            .level(
                                                Placement.PlacementLogistics.Handler.Certification
                                                    .Level
                                                    .STANDARD
