...
internal class ConnectServerEventTest {
    ...
    fun ofPong() {
        val pong =
            ConnectServerEvent.PetServerPongEvent.builder()
                .type(ConnectServerEvent.PetServerPongEvent.Type.PONG)
                .build()

        val connectServerEvent = ConnectServerEvent.ofPong(pong)

        assertThat(connectServerEvent.pong()).isEqualTo(pong)
    ...
    fun ofStatus() {
        val status =
            ConnectServerEvent.PetServerStatusEvent.builder()
                .pet(
                    Pet.builder()
                        .name("doggie")
                        .addPhotoUrl("string")
                ...
                .type(ConnectServerEvent.PetServerStatusEvent.Type.STATUS)
                .build()
