...
dependencies {
    testImplementation(project(":hello-world-testingggg-kotlin"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../hello-world-testingggg-kotlin-core/src/main/resources/META-INF/proguard/hello-world-testingggg-kotlin-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.hello_world_testingggg.api.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../hello-world-testingggg-kotlin-core/src/main/resources/META-INF/proguard/hello-world-testingggg-kotlin-core.pro",
